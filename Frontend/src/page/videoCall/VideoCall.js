...
// eslint-disable-next-line
  ...
  <div className='flex flex-col mx-6 my-2 h-full lg:flex-row lg:content-center'>
    <div
      className='w-full lg:w-1/2 h-64 lg:h-full lg:shadow-lg rounded-lg flex border-gray-200 p-4 mb-4 lg:mb-0'
      style={{backgroundColor: '#B5E3FE'}}
    >
      {UserVideo}
    </div>
    <div
      className='w-full lg:w-1/2 h-64 lg:h-full lg:shadow-lg rounded-lg flex border-gray-200 p-4'
