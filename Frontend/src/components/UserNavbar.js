          ...
          <div className='flex justify-between items-center py-3 md:justify-start md:space-x-10'>
            ...
            {state.data && state.data.type === "staff" && <Popover.Group
              ...
              <Popover.Group
                ...
                className='hidden md:flex space-x-10 mr-3'
              >
              {state &&state.data?.type === 'patient' &&<Link to='/prediction'>
                <div className='text-lg font-fontPro text-gray-800 hover:text-gray-500'>Prediction</div>
              </Link>}
                <Popover className='relative'>
                  {({open}) => (
                    <>
            ...
            <div className='rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 bg-white divide-y-2 divide-gray-50'>
              <div className='pt-5 pb-6 px-5'>
                <div className='flex items-center justify-between'>
                  <h1 className='text-lg'>Vaidya</h1>
                  <div className='-mr-2'>
